...
function CreateTask() {
  return (
    <div>
        ...
        <div className='mt-10'>
            <form className='bg-white p-8 rounded-lg shadow-lg max-w-4xl mx-auto'>
                <h3 className='text-gray-800 text-2xl font-semibold mb-6'>Create New Task</h3>
                    ...
                    <div>
                        <div className='mb-4'>
                            ...
                            <textarea 
                                ...
                                className='w-full p-3 bg-gray-100 text-gray-800 rounded border border-gray-300 focus:outline-none focus:border-blue-500 h-40 resize-none'
                            ></textarea>
                        </div>
                    </div>
                </div>
